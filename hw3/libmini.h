...
/* MY HW3 START */
#define SIGSET_SIZE 8  // unsigned long size

#define __SIGRTMAX 64
#define _NSIG __SIGRTMAX
...
#define gen_sigmask(signum) ((1UL) << (signum - 1))
...
long sys_rt_sigaction(int signum, struct sigaction *act, struct sigaction *old_act, size_t sigsetsize);
